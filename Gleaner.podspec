#
#  Be sure to run `pod spec lint Gleaner.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Ailsa" => "15623247725@163.com" }
  # Or just: spec.author    = "Ailsa"
  # spec.authors            = { "Ailsa" => "15623247725@163.com" }
  # spec.social_media_url   = "https://twitter.com/Ailsa"
  ...
  spec.source       = { :git => "https://github.com/AilsaYouCan/Gleaner", :tag => "#{spec.version}" }
